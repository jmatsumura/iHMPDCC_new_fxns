...
gql_map['subject_attr_alcohol'] = {"description": "What is patient's baseline alcohol consumption; type, drinks/week", "doc_type": "cases", "field": "subject attr alcohol", "full": "sample.SubjectAttr_alcohol", "type": "string"}
gql_map['subject_attr_allergies'] = {"description": "Does patient have allergies?", "doc_type": "cases", "field": "subject attr allergies", "full": "sample.SubjectAttr_allergies", "type": "string"}
gql_map['subject_attr_asthma'] = {"description": "Does patient have asthma? Yes/No, duration", "doc_type": "cases", "field": "subject attr asthma", "full": "sample.SubjectAttr_asthma", "type": "string"}
gql_map['subject_attr_cad'] = {"description": "Does patient have coronary artery disease/myocardial infarction? Yes/No, duration", "doc_type": "cases", "field": "subject attr cad", "full": "sample.SubjectAttr_cad", "type": "string"}
gql_map['subject_attr_chf'] = {"description": "Does patient have chronic heart failure? Yes/No, duration", "doc_type": "cases", "field": "subject attr chf", "full": "sample.SubjectAttr_chf", "type": "string"}
gql_map['subject_attr_comment'] = {"description": "Free-text comment", "doc_type": "cases", "field": "subject attr comment", "full": "sample.SubjectAttr_comment", "type": "string"}
gql_map['subject_attr_contact'] = {"description": "Does patient agree to be contacted in the future?", "doc_type": "cases", "field": "subject attr contact", "full": "sample.SubjectAttr_contact", "type": "string"}
gql_map['subject_attr_diabetes'] = {"description": "Does patient have diabetes (including gestational)? Yes/No, duration", "doc_type": "cases", "field": "subject attr diabetes", "full": "sample.SubjectAttr_diabetes", "type": "string"}
gql_map['subject_attr_education'] = {"description": "Subject's highest level of educatio", "doc_type": "cases", "field": "subject attr education", "full": "sample.SubjectAttr_education", "type": "string"}
gql_map['subject_attr_family_history'] = {"description": "Family history of hereditary diseases or physiological conditions", "doc_type": "cases", "field": "subject attr family history", "full": "sample.SubjectAttr_family_history", "type": "string"}
gql_map['subject_attr_gallbladder'] = {"description": "Does patient have gallbladder disease? Yes/No, duration, clarification", "doc_type": "cases", "field": "subject attr gallbladder", "full": "sample.SubjectAttr_gallbladder", "type": "string"}
gql_map['subject_attr_hyperlipidemia'] = {"description": "Does patient have hyperlipidemia? Yes/No, duration", "doc_type": "cases", "field": "subject attr hyperlipidemia", "full": "sample.SubjectAttr_hyperlipidemia", "type": "string"}
gql_map['subject_attr_hypertension'] = {"description": "Does patient have hypertension? Yes/No, duration", "doc_type": "cases", "field": "subject attr hypertension", "full": "sample.SubjectAttr_hypertension", "type": "string"}
gql_map['subject_attr_illicit_drug'] = {"description": "What is patient's baseline illicit drug history?", "doc_type": "cases", "field": "subject attr ilicit drug", "full": "sample.SubjectAttr_ilicit_drug", "type": "string"}
gql_map['subject_attr_kidney'] = {"description": "Does patient have kidney disease? Yes/No, duration", "doc_type": "cases", "field": "subject attr kidney", "full": "sample.SubjectAttr_kidney", "type": "string"}
gql_map['subject_attr_liver'] = {"description": "Does patient have liver disease? Yes/No, duration, clarification", "doc_type": "cases", "field": "subject attr liver", "full": "sample.SubjectAttr_liver", "type": "string"}
gql_map['subject_attr_lmp'] = {"description": "When was patient's last menstrual period, if applicable", "doc_type": "cases", "field": "subject attr lmp", "full": "sample.SubjectAttr_lmp", "type": "string"}
gql_map['subject_attr_occupation'] = {"description": "Subject's occupation", "doc_type": "cases", "field": "subject attr occupation", "full": "sample.SubjectAttr_occupation", "type": "string"}
gql_map['subject_attr_osa'] = {"description": "Does patient have obstructive sleep apnea? Yes/No, duration", "doc_type": "cases", "field": "subject attr osa", "full": "sample.SubjectAttr_osa", "type": "string"}
gql_map['subject_attr_pancreatitis'] = {"description": "Does patient have pancreatitis? Yes/No, duration", "doc_type": "cases", "field": "subject attr pancreatitis", "full": "sample.SubjectAttr_pancreatitis", "type": "string"}
gql_map['subject_attr_postmenopausal'] = {"description": "Is patient postmenopausal? Yes/No, duration", "doc_type": "cases", "field": "subject attr postmoenopausal", "full": "sample.SubjectAttr_postmenopausal", "type": "string"}
gql_map['subject_attr_pvd'] = {"description": "Does patient have peripheral vascular disease? Yes/No, duration", "doc_type": "cases", "field": "subject attr pvd", "full": "sample.SubjectAttr_pvd", "type": "string"}
gql_map['subject_attr_rx'] = {"description": "List all prescriptions and over the counter medication patient is taking at start of study", "doc_type": "cases", "field": "subject attr rx", "full": "sample.SubjectAttr_rx", "type": "string"}
gql_map['subject_attr_subtype'] = {"description": "The subtype of the Visit Attribute", "doc_type": "cases", "field": "subject attr subtype", "full": "sample.SubjectAttr_subtype", "type": "string"}
gql_map['subject_attr_survey_id'] = {"description": "Center specific survey identifier", "doc_type": "cases", "field": "subject attr survey ID", "full": "sample.SubjectAttr_survey_id", "type": "string"}
...
gql_map['visit_attr_comment'] = {"description": "Free-text comment", "doc_type": "cases", "field": "visit attr comment", "full": "sample.VisitAttr_comment", "type": "string"}
gql_map['visit_attr_dietary_log'] = {"description": "Dietary log", "doc_type": "cases", "field": "visit attr dietary log", "full": "sample.VisitAttr_dietary_log", "type": "string"}
gql_map['visit_attr_dietary_log_today'] = {"description": "Dietary log (today)", "doc_type": "cases", "field": "visit attr dietary log (today)", "full": "sample.VisitAttr_dietary_log_today", "type": "string"}
gql_map['visit_attr_disease'] = {"description": "Disease metadata", "doc_type": "cases", "field": "visit attr disease", "full": "sample.VisitAttr_disease", "type": "string"}
gql_map['visit_attr_exercise'] = {"description": "Exercise metadata", "doc_type": "cases", "field": "visit attr exercise", "full": "sample.VisitAttr_exercise", "type": "string"}
gql_map['visit_attr_health_assessment'] = {"description": "Health assessment metadata", "doc_type": "cases", "field": "visit attr health assessment", "full": "sample.VisitAttr_health_assessment", "type": "string"}
gql_map['visit_attr_hrt'] = {"description": "HRT metadata", "doc_type": "cases", "field": "visit attr HRT", "full": "sample.VisitAttr_hrt", "type": "string"}
gql_map['visit_attr_medications'] = {"description": "Medication metadata", "doc_type": "cases", "field": "visit attr medications", "full": "sample.VisitAttr_medications", "type": "string"}
gql_map['visit_attr_psych'] = {"description": "Psychiatric metadata", "doc_type": "cases", "field": "visit attr psych", "full": "sample.VisitAttr_psych", "type": "string"}
gql_map['visit_attr_subtype'] = {"description": "The subtype of the visit attribute", "doc_type": "cases", "field": "visit attr subtype", "full": "sample.VisitAttr_subtype", "type": "string"}
gql_map['visit_attr_survey_id'] = {"description": "Center specific survey identifier", "doc_type": "cases", "field": "visit attr survey ID", "full": "sample.VisitAttr_survey_id", "type": "string"}
gql_map['visit_attr_tests'] = {"description": "Tests metadata", "doc_type": "cases", "field": "visit attr tests", "full": "sample.VisitAttr_tests", "type": "string"}
...
gql_map['sample_fma_body_site'] = {"description": "Body site from which the sample was obtained using the FMA ontology", "doc_type": "cases", "field": "sample FMA body site", "full": "sample.Sample_fma_body_site", "type": "string"}
...
gql_map['file_format'] = {"description": "The format of the file", "doc_type": "cases", "field": "file format", "full": "sample.File_format", "type": "string"}
...
gql_map['file_annotation_pipeline'] = {"description": "The annotation pipeline used to generate the file", "doc_type": "cases", "field": "annotation pipeline which generated file", "full": "sample.File_annotation_pipeline", "type": "string"}
gql_map['file_matrix_type'] = {"description": "The type of matrix format present in the file", "doc_type": "cases", "field": "matrix format", "full": "sample.File_matrix_type", "type": "string"}
# MIMARKS
